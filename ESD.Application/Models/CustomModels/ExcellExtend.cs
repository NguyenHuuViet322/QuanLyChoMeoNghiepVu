...
namespace ESD.Application.Models.CustomModels
{
    ...
    public class ExportExtend2
    {
        public List<dynamic> Data { get; set; }
        public List<Col> Cols { get; set; }
        public List<Header> Headers { get; set; }
        /// <summary>
        /// Cần Tạo header excel hay không
        /// </summary>
        public bool IsCreateHeader { get; set; }
        public string Template { get; set; }
        public int RowStart { get; set; }
        public int ColStart { get; set; }
    }

    public class ExportExtend3
    {
        public List<dynamic> Data { get; set; }
        public List<Col> Cols { get; set; }
        public List<Header> Headers { get; set; }
        ...
        public List<DonViNghiepVu> description { get; set; }
        /// <summary>
        /// Cần Tạo header excel hay không
        /// </summary>
        public bool IsCreateHeader { get; set; }
