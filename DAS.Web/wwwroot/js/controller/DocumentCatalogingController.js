var DocumentCatalogingConfig = {
    Init: function () {

        $('#IDDocType').change(function () {
            DocumentCatalogingConfig.ChangeDocType($(this).val(), $("#divDocTypes").attr("data-profile"), $(this));
        ...
        DocumentCatalogingConfig.Dropzoneinit();
    },
    ChangeDocType: function (idDoctype, idProfile, obj) {
        let method = 'POST';
        let url = "/DocumentCataloging/ChangeDocType";
